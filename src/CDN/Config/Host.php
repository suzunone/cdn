...
class Host
{
    ...
    /**
     * @var bool hostヘッダをパイパスするかどうか
     */
    protected $bypass_http_host = false;
     ...
     * @return bool
     */
    public function getBypassHttpHost(): bool
    {
        return $this->bypass_http_host;
    }

    /**
     * hostヘッダをパイパスするかどうか
     *
     * @param bool $bypass_http_host
     * @return Host
     */
    public function setBypassHttpHost(bool $bypass_http_host): Host
    {
        $this->bypass_http_host = $bypass_http_host;
