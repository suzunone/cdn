...
class HostTest extends TestCase
{
    ...
    /**
     * @throws \ReflectionException
     * @covers \Suzunone\CDN\Config\Host::setBypassHttpHost()
     */
    public function test_setBypassHttpHost()
    {
        $host = new Host();


        $this->assertEquals(
            $this->invokeGetProperty($host, 'bypass_http_host'),
            false
        );

        $host->setBypassHttpHost(true);
    ...
    /**
     * @throws \ReflectionException
     * @covers \Suzunone\CDN\Config\Host::getBypassHttpHost()
     */
    public function test_getBypassHttpHost()
    {
        $host = new Host();

        $this->invokeSetProperty(
            $host,
            'bypass_http_host',
            false);
        $this->assertFalse($host->getBypassHttpHost());

        $this->invokeSetProperty(
            $host,
            'bypass_http_host',
            true);
        $this->assertTrue($host->getBypassHttpHost());
